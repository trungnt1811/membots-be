...
export class TruglyMemeception__createMemeResult {
  value0: Address;
  value1: Address;
...
export class TruglyMemeception__createMemeInputParamsStruct extends ethereum.Tuple {
  get name(): string {
    return this[0].toString();
  }
...
export class TruglyMemeception__createMeme404Result {
  value0: Address;
  value1: Address;
...
export class TruglyMemeception__createMeme404InputParamsStruct extends ethereum.Tuple {
  get name(): string {
    return this[0].toString();
  }
...
export class TruglyMemeception__createMeme404InputTiersStruct extends ethereum.Tuple {
  get baseURL(): string {
    return this[0].toString();
  }
...
export class TruglyMemeception__createMemeKOLResult {
  value0: Address;
  value1: Address;
...
export class TruglyMemeception__createMemeKOLInputParamsStruct extends ethereum.Tuple {
  get name(): string {
    return this[0].toString();
  }
...
export class TruglyMemeception__getMemeceptionResultValue0Struct extends ethereum.Tuple {
  get targetETH(): BigInt {
...
export class TruglyMemeception extends ethereum.SmartContract {
  static bind(address: Address): TruglyMemeception {
    return new TruglyMemeception("TruglyMemeception", address);
  }
  ...
  createMeme(
    params: TruglyMemeception__createMemeInputParamsStruct,
  ): TruglyMemeception__createMemeResult {
    ...
    return new TruglyMemeception__createMemeResult(
      result[0].toAddress(),
      result[1].toAddress(),
    );
  }
  ...
  try_createMeme(
    params: TruglyMemeception__createMemeInputParamsStruct,
  ): ethereum.CallResult<TruglyMemeception__createMemeResult> {
    ...
    return ethereum.CallResult.fromValue(
      new TruglyMemeception__createMemeResult(
        value[0].toAddress(),
        value[1].toAddress(),
      ),
    );
  ...
  createMeme404(
    params: TruglyMemeception__createMeme404InputParamsStruct,
    tiers: Array<TruglyMemeception__createMeme404InputTiersStruct>,
  ): TruglyMemeception__createMeme404Result {
    let result = super.call(
      "createMeme404",
    ...
    return new TruglyMemeception__createMeme404Result(
      result[0].toAddress(),
      result[1].toAddress(),
    );
  }
  ...
  try_createMeme404(
    params: TruglyMemeception__createMeme404InputParamsStruct,
    tiers: Array<TruglyMemeception__createMeme404InputTiersStruct>,
  ): ethereum.CallResult<TruglyMemeception__createMeme404Result> {
    let result = super.tryCall(
      "createMeme404",
      "createMeme404((string,string,uint40,uint16,uint16,bytes32,address,uint256),(string,string,string,uint256,uint256,uint256,uint256,bool)[]):(address,address)",
      [ethereum.Value.fromTuple(params), ethereum.Value.fromTupleArray(tiers)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new TruglyMemeception__createMeme404Result(
        value[0].toAddress(),
        value[1].toAddress(),
      ),
    );
  ...
  createMemeKOL(
    params: TruglyMemeception__createMemeKOLInputParamsStruct,
  ): TruglyMemeception__createMemeKOLResult {
    let result = super.call(
      "createMemeKOL",
    ...
    return new TruglyMemeception__createMemeKOLResult(
      result[0].toAddress(),
      result[1].toAddress(),
    );
  }
  ...
  try_createMemeKOL(
    params: TruglyMemeception__createMemeKOLInputParamsStruct,
  ): ethereum.CallResult<TruglyMemeception__createMemeKOLResult> {
    let result = super.tryCall(
      "createMemeKOL",
      "createMemeKOL((string,string,uint40,uint16,uint16,bytes32,address,uint256)):(address,address)",
      [ethereum.Value.fromTuple(params)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new TruglyMemeception__createMemeKOLResult(
        value[0].toAddress(),
        value[1].toAddress(),
      ),
    );
  ...
  getMemeception(
    memeToken: Address,
  ): TruglyMemeception__getMemeceptionResultValue0Struct {
    let result = super.call(
      "getMemeception",
    ...
    return changetype<TruglyMemeception__getMemeceptionResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_getMemeception(
    memeToken: Address,
  ): ethereum.CallResult<TruglyMemeception__getMemeceptionResultValue0Struct> {
    let result = super.tryCall(
      "getMemeception",
      "getMemeception(address):((uint256,uint256,uint256,address,uint16,address,uint40,uint40))",
      [ethereum.Value.fromAddress(memeToken)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<TruglyMemeception__getMemeceptionResultValue0Struct>(
        value[0].toTuple(),
      ),
    );
  }
