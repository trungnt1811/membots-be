...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.AffSearchResponseDto"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/console/orders/sync-reward": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "accesstrade order id to sync, required",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.SyncOrderRewardPayload"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.AffOrder": {
            ...
            "properties": {
                ...
                "transactions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.AffTransaction"
                    }
                },
                "update_time": {
                    "type": "string"
        ...
        "dto.AffSearchResponseDto": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/dto.AffSearchDto"
                },
                "next_page": {
                    "type": "integer"
                },
        ...
        "dto.AffTransaction": {
            ...
            "properties": {
                ...
                "accesstrade_order_id": {
                    "description": "NOTE: AccessTrade Order ID",
                    "type": "string"
                },
                "category_name": {
                    "type": "string"
        ...
        "dto.PostBackListResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.AffPostBack"
                    }
                },
                "page": {
                    "type": "integer"
        ...
        "dto.RewardSummary": {
            ...
            "properties": {
                "pending_reward_amount": {
                    "description": "amount of reward still locked",
                    "type": "number"
                },
                "pending_reward_order": {
                    "description": "number of orders that user not receive all reward",
                    "type": "integer"
                },
                "reward_in_day": {
                    "description": "amount of reward earn in day = 50% of total order approved today",
                    "type": "number"
                },
                "total_withdrew_amount": {
                    "description": "total amount of reward already withdrawn",
                    "type": "number"
                },
                "wait_for_approve_order": {
                    "description": "number of orders still waiting for approve",
                    "type": "integer"
                },
                "withdrawable_reward": {
                    "description": "amount of reward can be withdrawn at the moment",
                    "type": "number"
                }
            }
        },
