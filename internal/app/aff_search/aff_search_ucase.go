...
func (a *affSearchUCase) SearchWithStatus(ctx context.Context, q string, stellaStatus []string, page, size int) (dto.AffSearchResponseDto, error) {
	results, err := a.Repo.SearchWithStatus(ctx, q, stellaStatus, page, size)
	if err != nil {
