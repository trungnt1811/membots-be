...
type ATPostBackRequest struct {
	...
	ProductPrice       float32 `json:"product_price"`       // Giá của một sản phẩm
	Reward             float32 `json:"reward"`              // Hoa hồng nhận được
	...
	Status             uint8   `json:"status"`              // Status của đơn hàng gồm 3 giá trị: 0: new, 1: approved, 2: rejected
